...
Aether 同时提供上游管理、Codex 配置接管、渠道监控、请求日志、链动小铺市场监控、系统通知和应用内网页标签页。当前版本为 `0.1.0-alpha.9`，仍处于早期测试阶段，配置格式和交互可能继续调整。
...
| Codex 配置 | Provider 接管与恢复、本地 Base URL/API Key、会话迁移、提示词预设、Skills 启停、按备份账本恢复官方会话 |
...
- 编辑已添加账号的名称、优先级、权重、并发和成本倍率；API Key 中转站还可更换 Key、Base URL 和模型白名单。
