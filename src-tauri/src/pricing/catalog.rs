...
const MODEL_PRICES: &[ModelPrice] = &[
    ...
    ModelPrice {
        model: "gpt-5.6-terra",
        input: 2.0 * USD_PER_MILLION,
        output: 12.0 * USD_PER_MILLION,
        cache_read: Some(0.2 * USD_PER_MILLION),
        cache_write: Some(2.5 * USD_PER_MILLION),
        priority_multiplier: Some(2.0),
        flex_multiplier: Some(0.5),
        long_context: true,
    },
    ModelPrice {
        model: "gpt-5.6-luna",
        input: 0.2 * USD_PER_MILLION,
        output: 1.2 * USD_PER_MILLION,
        cache_read: Some(0.02 * USD_PER_MILLION),
        cache_write: Some(0.25 * USD_PER_MILLION),
        priority_multiplier: Some(2.0),
        flex_multiplier: Some(0.5),
        long_context: true,
    },
